    ...
    try {
      ...
      const stackedBarData1 = [
        ...
        },
        {
          label: "Kurang Setuju",
          data: Array(numQuestions).fill(0),
          backgroundColor: "rgba(153, 50, 255, 0.6)", // Color for "tidak"
        },
        {
          label: "Setuju",
          data: Array(numQuestions).fill(0),
          backgroundColor: "rgba(40, 102, 255, 0.6)", // Color for "tidak"
        },
        {
          label: "Sangat Setuju",
          data: Array(numQuestions).fill(0),
          backgroundColor: "rgba(80, 102, 255, 0.6)", // Color for "tidak"
        },
      ];
      ...
      dataAns1.forEach((ans: AnswerData) => {
        ans.ans.forEach((answer, qIndex) => {
          if (qIndex < numQuestions && answer >= 0 && answer <= 4) {
            stackedBarData1[answer].data[qIndex] += 1;
          }
          console.log(answer); // For debugging purposes, this can be left as is
        });
      });
      dataAns2.forEach((ans: AnswerData) => {
        ans.ans.forEach((answer, qIndex) => {
          if (qIndex < numQuestions && answer >= 0 && answer <= 4) {
            stackedBarData2[answer].data[qIndex] += 1;
          }
          console.log(answer); // For debugging purposes, this can be left as is
        });
      });
